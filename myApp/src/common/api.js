...
const sendSessionCode = (data, succ, fail) => {
 ...
 */
const saveUserInfoScore = (data, succ, fail, isShow) => {
  const url = "https://www.zoomwei.cn/api/5975aa40c4afd.html";
  var data = data || {};
  Taro.request(url, data, succ, fail, 'get', isShow);
}
  ...
  * 无参数
  */
const getWxUserScore = (data, succ, fail) => {
